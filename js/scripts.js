$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Matrimonio Francesca e Ludovico",

            // Event start date
            start: new Date('Sep 06, 2025 10:30'),
            ...
            // Event Address
            address: 'Piazza Maria Ausiliatrice, 9, 10152 Torino TO',
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'fb8c725b3c4c464d008d4025f447004f') {
  ...
  //          $.post('https://script.google.com/macros/s/AKfycbyT5GeDiD4iaqZMypeV5TSXMRrmpf-kPsWYFow3YXxdplHOO5I0ZQ3WW09hsiNa_IrX9Q/exec' , data)
  //              .done(function (data) {
  //                  console.log(data);
